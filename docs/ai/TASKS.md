...
- `REQ-177` | `todo` | Inyectar los estilos `.row-alert-bg` y `.badge-danger` en `static/style.css` y cubrir el comportamiento con pruebas de modelo/vista para estados activos, estados terminales y ubicación correcta del badge en ambas tablas.
