...
- `/bodega` móvil ya inició con una primera iteración de cards móviles; `bodega_preparar.html` ya tiene primera iteración móvil de ítems. Quedan pendientes validación manual y las vistas `bodega_gestionar.html` y `bodega_entrega_parcial.html`.
