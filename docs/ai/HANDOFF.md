...
- `/bodega` móvil ya inició con una primera iteración de cards móviles; quedan pendientes validación manual y las vistas `bodega_preparar.html`, `bodega_gestionar.html` y `bodega_entrega_parcial.html`.
